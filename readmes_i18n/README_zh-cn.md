...
2. **部署 Judge0：**
    ...
    您的 Judge0 CE v1.13.1 实例现在已经启动并运行；访问 http://<您的服务器 IP 地址>:2358/docs 获取文档。
...
3. **启动 memos**
    ...
    此时就可以在 http://<您的服务器 IP 地址>:5230 访问到 memos，在 memos 中的设置中获取 Tokens
...
1.  **准备 Ubuntu 22.04 或更高版本的环境，以及 Docker，并配置 cgroup v1:**
...
2.  **部署 Judge0:**
    ...
    您的 Judge0 CE v1.13.1 实例现在应该已经启动并运行，请访问 http://<您的服务器 IP 地址>:2358/docs 查看相关文档。
...
1.  **准备 Ubuntu 22.04 或更高版本的环境，以及 Docker:**
...
3.  **启动 Memos:**
    ...
    现在您可以在 http://<您的服务器 IP 地址>:5230 访问 Memos。在 Memos 的设置中获取 Tokens。
